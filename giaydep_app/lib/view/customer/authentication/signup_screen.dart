...
class _LoginScreen extends State<SignUpScreen> {
  ...
  bool _obscureText = true; // Biến để theo dõi trạng thái ẩn/hiện của mật khẩu
  bool _obscureReEnterText = true; // Biến để theo dõi trạng thái ẩn/hiện của mật khẩu nhập lại
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                keyboardType: TextInputType.text,
                obscureText: _obscureReEnterText, // Ẩn/hiện mật khẩu nhập lại
                decoration: InputDecoration(
                  contentPadding: const EdgeInsets.all(8),
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(
                      _obscureReEnterText ? Icons.visibility : Icons.visibility_off,
                      color: Colors.grey,
                    ),
                    onPressed: () {
                      setState(() {
                        _obscureReEnterText = !_obscureReEnterText; // Đảo ngược trạng thái ẩn/hiện
                      });
                    },
                  ),
                ),
