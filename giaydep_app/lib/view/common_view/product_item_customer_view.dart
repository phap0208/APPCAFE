...
class _ProductItemCustomerView extends State<ProductItemCustomerView> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Card(
        color: Colors.white,
        margin: const EdgeInsets.only(top: 12, left: 10, right: 8, bottom: 12),
        elevation: 40,
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButtonCreateOrder(
                  ...
                  title: "lên đơn", // Changed text here
  ...
  Widget productItemImage() {
    if (widget.product.image.isNotEmpty) {
      return Image.network(
        height: 120,
        width: double.infinity, // Đảm bảo chiều rộng tối đa cho ảnh
        fit: BoxFit.cover, // Chỉnh ảnh để phù hợp với kích thước chứa
